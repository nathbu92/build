...
// Repo : https://github.com/nathbu92/chronoapp
// Règles : silencieux si hors-ligne, jamais bloquant
// ══════════════════════════════════════════════════════════════
const GITHUB_RELEASES_API = 'https://api.github.com/repos/nathbu92/chronoapp/releases/latest';
...
async function checkForUpdate() {
  try {
    ...
    const releaseUrl    = release.html_url || 'https://github.com/nathbu92/chronoapp/releases/latest';
...
function registerHandlers() {
  ...
  ipcMain.handle('update:openRelease', (_, url) => {
    const safe = (url || '').startsWith('https://github.com/') ? url : 'https://github.com/nathbu92/chronoapp/releases/latest';
